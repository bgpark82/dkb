 ...
 */
@ConfigurationParameter(key = GLUE_PROPERTY_NAME, value = "com.bgpark.demo.dkb.api.e2e.serenity.steps, com.bgpark.demo.dkb.api.e2e")
/**
* CUCUMBER_PLUGIN: "cucumber.plugin"
* PLUGIN: 테스트 결과를 다양한 형식으로 출력하는 확장기능
* 실행 시 리포트를 어떻 포멧으로 남길지 설정
* Serenity에서는 Serenity.properties에서 설정
*/
